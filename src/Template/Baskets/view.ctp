...
<div class="box">
    <div class="box-body">
        <?= $this->Form->postLink(
                ...
                ['escape' => false, 'confirm' => __('Valóban törölni szeretnéd: #{0}?', $basket->id)]
            )
        ?>
    ...
    <?= $this->Form->create($basket,['class'=>'form-horizontal']) ?>
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?php echo $this->Form->input('cookie', ['label'=>false, 'class'=>'form-control', 'autofocus'=>false, 'disabled'=>true ]); ?>
                </div>
            </div>            
            <div class="form-group">
        ...
        <div class="box-footer">
            ...
            <div class="col-sm-10">
                <a class="btn btn-success" href="<?php if($admin){echo "/admin";}?>/baskets/edit/<?= $basket->id ?>"><i class="fa fa-fw fa-edit"></i> Módosít</a>
