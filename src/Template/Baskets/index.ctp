						...
						<table aria-describedby="baskets" role="grid" id="baskets" class="table table-striped table-bordered table-hover dataTable">
							...
							<thead>
								<tr role="row">
									...
									<th style="border-bottom: 2px solid lightgray; width: 140px; text-align: left; padding-left: 10px;" aria-label="" colspan="1" rowspan="1" aria-controls="baskets" tabindex="0" class="sorting"><?= $this->Paginator->sort('modified','Módosítva') ?></th>
...
<?php foreach ($baskets as $basket): ?> 
								<tr row-id="<?= $basket->id ?>">
									...
									<td style="text-align: left; padding-left: 7px;"><?= h($basket->cookie) ?></td>
									...
									<td style="text-align: center;"><?= $this->Time->format( $basket->modified, 'yyyy.MM.dd. HH:mm:ss', null, $basket->time_zone ); ?></td>
...
<?php endforeach; ?>
							...
							<tfoot>
								<tr role="row">
									<th style="border-top: 2px solid lightgray; width: 40px; text-align: center; " aria-label="" colspan="1" rowspan="1" aria-controls="baskets" tabindex="0" aria-sort="ascending" class="sorting_asc"><?= $this->Paginator->sort('id','#id') ?></th>
									<th style="border-top: 2px solid lightgray; " aria-label="" colspan="1" rowspan="1" aria-controls="baskets" tabindex="0" class="sorting"><?= $this->Paginator->sort('cookie','') ?></th>
									<th style="border-top: 2px solid lightgray; " aria-label="" colspan="1" rowspan="1" aria-controls="baskets" tabindex="0" class="sorting"><?= $this->Paginator->sort('name','') ?></th>
									<th style="border-top: 2px solid lightgray; " aria-label="" colspan="1" rowspan="1" aria-controls="baskets" tabindex="0" class="sorting"><?= $this->Paginator->sort('zip','') ?></th>
									<th style="border-top: 2px solid lightgray; " aria-label="" colspan="1" rowspan="1" aria-controls="baskets" tabindex="0" class="sorting"><?= $this->Paginator->sort('city','') ?></th>
									<th style="border-top: 2px solid lightgray; " aria-label="" colspan="1" rowspan="1" aria-controls="baskets" tabindex="0" class="sorting"><?= $this->Paginator->sort('address','') ?></th>
									<th style="border-top: 2px solid lightgray; " aria-label="" colspan="1" rowspan="1" aria-controls="baskets" tabindex="0" class="sorting"><?= $this->Paginator->sort('phone','') ?></th>
									<th style="border-top: 2px solid lightgray; " aria-label="" colspan="1" rowspan="1" aria-controls="baskets" tabindex="0" class="sorting"><?= $this->Paginator->sort('email','') ?></th>
									<th style="border-top: 2px solid lightgray; " aria-label="" colspan="1" rowspan="1" aria-controls="baskets" tabindex="0" class="sorting"><?= $this->Paginator->sort('status','') ?></th>
									<th style="border-top: 2px solid lightgray; width: 140px; text-align: left; padding-left: 10px;" aria-label="" colspan="1" rowspan="1" aria-controls="baskets" tabindex="0" class="sorting"><?= $this->Paginator->sort('created','Készült') ?></th>
									<th style="border-top: 2px solid lightgray; width: 140px; text-align: left; padding-left: 10px;" aria-label="" colspan="1" rowspan="1" aria-controls="baskets" tabindex="0" class="sorting"><?= $this->Paginator->sort('modified','Módosítva') ?></th>
									<th style="border-top: 2px solid lightgray; width: 110px; text-align: left; padding-left: 10px;" aria-label="" colspan="1" rowspan="1" aria-controls="baskets" tabindex="0">Műveletek</th>
								</tr>
							</tfoot>
						</table>
					</div>
