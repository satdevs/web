...
<div class="box box-info">
    ...
    <?= $this->Form->create($internetextra,['class'=>'form-horizontal']) ?>
        <div class="box-body">
            ...
            <div class="form-group">
                <label for="group_id" class="col-sm-1 control-label">Ügyfélszám:</label>
                <div class="col-sm-10">
                    <?php echo $this->Form->input('custno', ['label'=>false, 'class'=>'form-control', 'autofocus'=>false, 'disabled'=>false ]); ?>
                </div>
            </div>            
            <div class="form-group">
                <label for="group_id" class="col-sm-1 control-label">E-mail:</label>
                <div class="col-sm-10">
                    <?php echo $this->Form->input('email', ['label'=>false, 'class'=>'form-control', 'autofocus'=>false, 'disabled'=>false ]); ?>
                </div>
            </div>            
            <div class="form-group">
                <label for="group_id" class="col-sm-1 control-label">Település:</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <label for="group_id" class="col-sm-1 control-label">Igényelve:</label>
                <div class="col-sm-10">
                    <?php echo $this->Form->input('accept', ['label'=>false, 'class'=>'form-control', 'autofocus'=>false, 'disabled'=>false ]); ?>
                </div>
            </div>            
            <div class="form-group">
                <label for="group_id" class="col-sm-1 control-label">Adatkezelés:</label>
                <div class="col-sm-10">
