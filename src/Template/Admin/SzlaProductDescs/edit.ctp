...
<div class="box">
	<div class="box-body">
		<?= $this->Form->postLink(
				...
				['action' => 'delete', $productDesc->id],
				['escape' => false, 'confirm' => __('Valóban törölni szeretnéd: #{0}?', $productDesc->id)]
			)
		?>
...
*/ ?>
			...
			<div class="form-group">
				<label for="net_without_tv_id" class="col-sm-1 control-label">NET fő id:</label>
				<div class="col-sm-2">
					<?php echo $this->Form->input('net_without_tv_id', ['type'=>'number', 'label'=>false, 'class'=>'form-control', 'autofocus'=>false, 'disabled'=>false ]); ?>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-1">
					<?php echo $this->Form->input('visible', ['type'=>'checkbox', 'label'=>false, 'class'=>'form-control', 'autofocus'=>false, 'disabled'=>false ]); ?>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8" style="padding-top: 10px;">
					<p>&larr; Ár számításnál EZT az akciós csomagot vegye figyelembe! (Digi csomagoknál az xXx licenc díj hozzáadás miatt jelöld be!)</p>
				</div>
			</div>
			<div class="form-group">
				<label for="visible" class="col-sm-1 control-label">Licenc díj (xXx):</label>
				<div class="col-sm-2">
					<?php echo $this->Form->input('licenc_price', ['type'=>'number', 'label'=>false, 'class'=>'form-control', 'placeholder'=>'Kártya licenc díja', 'autofocus'=>false, 'disabled'=>false ]); ?>
				</div>
				<div class="col-sm-8" style="padding-top: 10px;">
