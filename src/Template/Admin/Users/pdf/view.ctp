    ...
    <?= $this->Form->create($user,['class'=>'form-horizontal']) ?>  
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?= $this->Form->input('password', ['label'=>false, 'class'=>'form-control', 'placeholder'=>'Jelszó', 'type'=>'password', 'autofocus'=>false, 'disabled'=>true]); ?>
                </div>
            </div>
        </div>
        ...
        <div class="box-footer">
            ...
            <div class="col-sm-10">
                <a style="margin-left: 10px;" class="btn btn-success" href="/users/edit/<?= $user->id ?>"><i style="font-size: 16px;" class="fa fa-fw fa-edit"></i> Módosít</a>
                <a style="margin-left: 10px;" class="btn btn-default" href="/users/index"><i class="fa fa-fw fa-close"></i> Mégsem</a>
            </div>
        </div>
        <!-- /.box-footer -->
