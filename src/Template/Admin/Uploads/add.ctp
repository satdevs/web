...
<div class="box box-info">
	<div class="box-header with-border">
		...
		<div class="col-sm-10">
			<h3 class="box-title"><?= __('Új file feltöltése') ?></h3>
		</div>
	</div>

	<?= $this->Form->create($upload,['class'=>'form-horizontal', 'enctype'=>'multipart/form-data']) ?>
		<div class="box-body">
			<div class="form-group">
				<label for="group_id" class="col-sm-1 control-label">File(ok):</label>
				<div class="col-sm-9">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?php echo $this->Form->input('current', ['label'=>false, 'class'=>'form-control', 'autofocus'=>true, 'disabled'=>false, 'checked'=>true ]); ?>
                </div>
            </div>            
            ...
            <div class="form-group">
                <label for="pos" class="col-sm-1 control-label">Hatályos:</label>
                <div class="col-sm-2">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <?php echo $this->Form->input('pos', ['label'=>false, 'class'=>'form-control', 'autofocus'=>false, 'disabled'=>false, 'value'=>500]); ?>
                </div>
            </div>
            <div class="form-group">
                <label for="visible" class="col-sm-1 control-label">Látható:</label>
                <div class="col-sm-10">
                    <?php echo $this->Form->input('visible', ['label'=>false, 'class'=>'form-control', 'autofocus'=>true, 'disabled'=>false, 'checked'=>true ]); ?>
                </div>
            </div>            
            <div class="form-group">
