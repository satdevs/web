...
<div class="box">
    <div class="box-body">
        <?= $this->Form->postLink(
                ...
                ['escape' => false, 'confirm' => __('Valóban törölni szeretnéd: #{0}?', $upload->id)]
            )
        ?>
...
<div class="box box-info">
    ...
    <?= $this->Form->create($upload,['class'=>'form-horizontal']) ?>
        <div class="box-body">
            ...
            <div class="form-group">
                <label for="group_id" class="col-sm-1 control-label">Text:</label>
                <div class="col-sm-10">
                    <?php echo $this->Form->input('text', ['label'=>false, 'class'=>'form-control', 'autofocus'=>false, 'disabled'=>true ]); ?>
                </div>
            </div>            
            <div class="form-group">
                <label for="group_id" class="col-sm-1 control-label">Filename:</label>
                <div class="col-sm-10">
                    <?php echo $this->Form->input('filename', ['label'=>false, 'class'=>'form-control', 'autofocus'=>false, 'disabled'=>true ]); ?>
                </div>
            </div>            
            <div class="form-group">
                <label for="group_id" class="col-sm-1 control-label">Silesize:</label>
                <div class="col-sm-10">
                    <?php echo $this->Form->input('silesize', ['label'=>false, 'class'=>'form-control', 'autofocus'=>false, 'disabled'=>true ]); ?>
                </div>
            </div>            
        </div><!-- /.box-body -->
        ...
        <div class="box-footer">
            ...
            <div class="col-sm-10">
                <a class="btn btn-success" href="<?php if($admin){echo "/admin";}?>/uploads/edit/<?= $upload->id ?>"><i class="fa fa-fw fa-edit"></i> Módosít</a>
