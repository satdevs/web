...
<div class="box">
    <div class="box-body">
        <?= $this->Form->postLink(
                ...
                ['escape' => false, 'confirm' => __('Valóban törölni szeretnéd: #{0}?', $feature->id)]
            )
        ?>
...
<div class="box box-info">
    ...
    <?= $this->Form->create($feature,['class'=>'form-horizontal']) ?>
        <div class="box-body">
        ...
        <div class="box-footer">
            ...
            <div class="col-sm-10">
                <a class="btn btn-success" href="<?php if($admin){echo "/admin";}?>/features/edit/<?= $feature->id ?>"><i class="fa fa-fw fa-edit"></i> Módosít</a>
                <a style="margin-left: 10px;" class="btn btn-default" href="<?php if($admin){echo "/admin";}?>/ch_features/index"><i class="fa fa-fw fa-close"></i> Mégsem</a>
            </div>
        </div><!-- /.box-footer -->
