...
<div class="box">
    ...
    <div class="box-body">
        <?= $this->Form->postLink(
                ...
                ['escape' => false, 'confirm' => __('Valóban törölni szeretnéd: #{0}?', $group->id)]
            )
        ?>
    ...
    <?= $this->Form->create($group,['class'=>'form-horizontal']) ?>
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?php echo $this->Form->input('description', ['label'=>false, 'class'=>'form-control', 'autofocus'=>false, 'disabled'=>true ]); ?>
                </div>
            </div>            
        </div><!-- /.box-body -->
        ...
        <div class="box-footer">
            ...
            <div class="col-sm-10">
                <a class="btn btn-success" href="<?php if($admin){echo "/admin";}?>/groups/edit/<?= $group->id ?>"><i class="fa fa-fw fa-edit"></i> Módosít</a>
