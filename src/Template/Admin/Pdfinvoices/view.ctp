    ...
    <?= $this->Form->create($pdfinvoice,['class'=>'form-horizontal']) ?>
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?php echo $this->Form->input('sub_id', ['label'=>false, 'class'=>'form-control', 'autofocus'=>false, 'disabled'=>true ]); ?>
                </div>
            </div>            
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?php echo $this->Form->input('hash', ['label'=>false, 'class'=>'form-control', 'autofocus'=>false, 'disabled'=>true ]); ?>
                </div>
            </div>            
        </div><!-- /.box-body -->
        ...
        <div class="box-footer">
            ...
            <div class="col-sm-10">
                <a class="btn btn-success" href="<?php if($admin){echo "/admin";}?>/pdfinvoices/edit/<?= $pdfinvoice->id ?>"><i class="fa fa-fw fa-edit"></i> Módosít</a>
