...
<div class="box box-info">
    ...
    <?= $this->Form->create($basket,['class'=>'form-horizontal']) ?>
        <div class="box-body">
            ...
            <div class="form-group">
                <label for="content" class="col-sm-1 control-label">Tartalom:</label>
                <div class="col-sm-10">
                    <?php echo $this->Form->input('content', ['label'=>false, 'class'=>'form-control', 'autofocus'=>true, 'disabled'=>false ]); ?>
                </div>
            </div>            
            <div class="form-group">
