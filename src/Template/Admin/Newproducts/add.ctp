...
<div class="box box-info">
    ...
    <?= $this->Form->create($newproduct,['class'=>'form-horizontal']) ?>
        <div class="box-body">
            ...
            <div class="form-group">
                <label for="group_id" class="col-sm-1 control-label">Ár:</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?php echo $this->Form->input('visible', ['label'=>false, 'class'=>'form-control', 'autofocus'=>false, 'disabled'=>false, 'checked'=>true ]); ?>
                </div>
            </div>            
        </div><!-- /.box-body -->
