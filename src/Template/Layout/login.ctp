...
<head>
  ...
  <title>Sághy-Sat | Bejelentkezés</title>
  ...
  <link rel="stylesheet" href="/css/AdminLTE.min.css"><!-- Theme style -->
...
<script src="/js/jQuery-2.2.0.min.js"></script><!-- jQuery 2.2.0 -->
<script src="/js/bootstrap.min.js"></script><!-- Bootstrap 3.3.6 -->
