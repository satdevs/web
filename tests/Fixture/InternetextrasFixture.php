...
/**
 * InternetextrasFixture
 *
 */
class InternetextrasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'custno' => ['type' => 'string', 'length' => 10, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'accept' => 1,
            'created' => '2022-01-24 10:33:41',
            'modified' => '2022-01-24 10:33:41'
        ],
    ];
}
