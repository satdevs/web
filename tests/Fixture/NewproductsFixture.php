 ...
 *
 */
class NewproductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'headstation_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'headstation_id' => ['type' => 'index', 'columns' => ['headstation_id'], 'length' => []],
    ...
    public $records = [
        [
            ...
            'pos' => 1,
            'visible' => 1,
            'created' => '2018-06-26 13:19:48',
            'modified' => '2018-06-26 13:19:48'
        ],
    ];
}
